...
/// <summary>
/// Applies a promotional price below the product's list price (H5b / D3).
///
/// <para>
/// This changes what a customer pays, so it invalidates exactly what a list-price change does —
/// both detail variants, the category list, and the whole <c>products:list</c> family — and the
