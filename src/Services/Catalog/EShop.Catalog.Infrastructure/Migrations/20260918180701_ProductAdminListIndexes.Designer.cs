...
namespace EShop.Catalog.Infrastructure.Migrations
{
    ...
    [Migration("20260918180701_ProductAdminListIndexes")]
    partial class ProductAdminListIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EShop.Catalog.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasIndex(new[] { "Status", "CategoryId" }, "IX_Products_Status_CategoryId");

                    b.HasIndex(new[] { "Status", "StockQuantity" }, "IX_Products_Status_StockQuantity");
            ...
            modelBuilder.Entity("EShop.Catalog.Domain.Entities.ProductImage", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("ProductId", "IsMain", "DisplayOrder"), new[] { "Url" });
