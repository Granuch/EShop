...
public sealed class PaymentCompletedConsumer : IdempotentConsumer<PaymentCompletedEvent, NotificationDbContext>
{
    private const string TemplateName = "payment-completed";
    ...
    protected override async Task HandleAsync(ConsumeContext<PaymentCompletedEvent> context, CancellationToken cancellationToken)
    {
