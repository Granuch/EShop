...
try
{
    ...
    // Shared across every service â€” see EShopForwardedHeaders for why KnownNetworks matters
    ...
    // mints a confirmation token and immediately discards it â€” it is on neither RegisterResponse
    // nor UserRegisteredIntegrationEvent â€” while the response still tells the caller to check
