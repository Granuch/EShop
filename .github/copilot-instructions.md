...
- For documentation updates, rewrite content to match current project reality, keep the existing docs file/folder structure, write in English, and avoid mentioning Copilot activities.