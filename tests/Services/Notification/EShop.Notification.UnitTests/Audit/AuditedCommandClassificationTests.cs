...
namespace EShop.Notification.UnitTests.Audit;

/// <summary>
/// Admin panel S15. Every command in Notification's Application assembly is classified — audited or not, with a reason — so a new
...
public class AuditedCommandClassificationTests
{
    ...
    [
        "MarkNotificationUndeliverableCommand",
        "ResendNotificationCommand",
        "RetryFailedNotificationsCommand",
    ...
    private static readonly Type[] Requests = typeof(ResendNotificationCommand).Assembly.GetTypes()
