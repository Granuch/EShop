...
namespace EShop.Identity.UnitTests.Audit;

/// <summary>
/// Admin panel S15. Every command in Identity's Application assembly is classified — audited or not, with a reason — so a new
...
public class AuditedCommandClassificationTests
{
    ...
    [
        ...
        "DeleteRoleCommand",
        "DeleteUserCommand",
        "DisableUserTwoFactorCommand",
        "LockUserCommand",
        "RemoveUserFromRoleCommand",
        "ResetUserPasswordCommand",
        "RestoreUserCommand",
        "RevokeUserTokensCommand",
        "SetUserRolesCommand",
        "UnlockUserCommand",
        "UpdateRoleCommand",
    ...
    {
        ["ChangePasswordCommand"] = "customer self-service on the caller's own account",
        ["ConfirmEmailCommand"] = "anonymous account flow",
        ["Disable2FACommand"] = "customer self-service on the caller's own account",
        ["Enable2FACommand"] = "customer self-service on the caller's own account",
        ["ForgotPasswordCommand"] = "anonymous account flow",
        ...
        ["Verify2FACommand"] = "customer self-service on the caller's own account",
    };

    private static readonly Type[] Requests = typeof(CreateUserCommand).Assembly.GetTypes()
